...
export const loadInfoData = () => {
    var data = data_Information;
    return data;
}

export const loadUsedData = () => {
...
const data_Information = [
    { id: 1, title: "[환경부] 분리배출 방법, 꼼꼼히 알려드려요!", user_id: "운영자", createdAt: "2024-07-11", likes: 0, contents: "https://www.me.go.kr/home/web/board/read.do?menuId=&boardId=853220&boardMasterId=713" },
    { id: 2, title: "[영등포구] 카페에서 개인컵 쓰면 `할인＋서울페이 적립` 400원 이상 혜택", user_id: "운영자", createdAt: "2024-07-02", likes: 0, contents: "내용" },
    { id: 3, title: "[강동구] 쓰레기배출안내", user_id: "운영자", createdAt: "2024-06-24", likes: 0, contents: "" },
    { id: 4, title: "[중랑구] 재활용품 분리 배출 안내", user_id: "운영자", createdAt: "2024-06-08", likes: 0, contents: "" },
    { id: 5, title: "[용산구] 생활쓰레기 배출 안내", user_id: "운영자", createdAt: "2024-06-01", likes: 0, contents: "" },
    { id: 6, title: "[관악구] 생활계 유해폐기물 배출안내", user_id: "운영자", createdAt: "2024-05-22", likes: 0, contents: "내용" },
    { id: 7, title: "[중구] 재활용품 분리배출", user_id: "운영자", createdAt: "2024-05-13", likes: 0, contents: "" },
    { id: 8, title: "[동작구] 생활쓰레기 배출 안내", user_id: "운영자", createdAt: " 2024-05-10", likes: 0, contents: "" },
    { id: 9, title: "제목9", user_id: "사용자9", createdAt: "20240101", likes: 1, contents: "" },
    { id: 10, title: "제목10", user_id: "사용자10", createdAt: "20240101", likes: 1, contents: "" },
...
const data_usedtransaction = [
    { id: 1, title: "캥골 백팩 팝니다", user_id: "짱돌", createdAt: "2024-07-13 19:26", likes: 9, contents: "\
        <h4>제곧내</h4>\
        제곧내 "},
        // 사<br>든<br>가<br> <br>말<br>든<br>가\
        // " },
    { id: 2, title: "행거", user_id: "고양이사랑해", createdAt: "2024-07-07 22:43", likes: 2, contents: "" },
    { id: 3, title: "의자 3개랑 식탁 나눔", user_id: "붉은노을", createdAt: "2024-07-01 20:54", likes: 11, contents: "" },
    { id: 4, title: "세발자전거 (유아용)", user_id: "동작버섯", createdAt: "2024-06-28 07:01", likes: 7, contents: "" },
    { id: 5, title: "원피스", user_id: "카라", createdAt: "2024-06-24 09:16", likes: 3, contents: "" },
    { id: 6, title: "이사로 정리 급처 다해서 5천원", user_id: "기니", createdAt: "2024-06-19 16:45", likes: 13, contents: "" },
    { id: 7, title: "4인 소파", user_id: "숭식이", createdAt: "2024-06-15 11:21", likes: 6, contents: "" },
    { id: 8, title: "샘송 가습기 팝니다", user_id: "오이오이오", createdAt: "2024-06-13 17:55", likes: 8, contents: "" },
    { id: 9, title: "제목9", user_id: "사용자9", createdAt: "20240101", likes: 1, contents: "" },
    { id: 10, title: "제목10", user_id: "사용자10", createdAt: "20240101", likes: 1, contents: "" },
    // { id: 11, title: "제목11", user_id: "사용자11", createdAt: "20240101", likes: 1, contents: "" },
    // { id: 12, title: "제목12", user_id: "사용자12", createdAt: "20240101", likes: 1, contents: "" },
